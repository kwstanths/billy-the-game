...
void main(){
    ...
    vec3 light_ambient = light_properties.ambient * object_material.ambient;
	...
	vec3 light_diffuse = light_properties.diffuse * light_diffuse_strength * object_material.diffuse;
	...
	vec3 light_specular = light_properties.specular * light_specular_strength * object_material.specular;
	
	
	/* Sum the two components */
	/* Specular light is currently not used */
    color = (light_ambient + light_diffuse + light_specular) * texture(sampler_texture, uv).rgb;
