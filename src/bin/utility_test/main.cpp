...
int main(int argc, char ** argv) {
    ...
    tree.Init(ge::math::Rectangle2D(
        ge::math::Point2D(-200,-200), 
        ge::math::Point2D(200,-200), 
        ge::math::Point2D(200, 200), 
        ge::math::Point2D(-200, 200)),
        &pool
    ...
    size_t noo = tree.QueryRange(ge::math::Rectangle2D(
        ge::math::Point2D(0,0), 
        ge::math::Point2D(200,0), 
        ge::math::Point2D(200, 200), 
        ge::math::Point2D(0, 200)), objects);
    ...
    noo = tree.QueryRange(ge::math::Rectangle2D(
        ge::math::Point2D(0,0), 
        ge::math::Point2D(200,0), 
        ge::math::Point2D(200, 200), 
        ge::math::Point2D(0, 200)), objects);
    ...
    noo = tree.QueryRange(ge::math::Rectangle2D(
        ...
        ge::math::Point2D(200,-200), 
        ge::math::Point2D(200, 200), 
        ge::math::Point2D(-200, 200)), objects);
    ...
    tree.Init(ge::math::Rectangle2D(
        ge::math::Point2D(0, 0), 
        ge::math::Point2D(500000, 0), 
        ge::math::Point2D(500000, 500000), 
        ge::math::Point2D(0, 500000)),
        &pool);
    ...
    dt::Console("---------------------------");
    tree.PrettyPrint();
    ge::math::Rectangle2D search_area(
        ge::math::Point2D(0, 0), 
        ge::math::Point2D(200, 0), 
        ge::math::Point2D(200, 200), 
        ge::math::Point2D(0, 200)
