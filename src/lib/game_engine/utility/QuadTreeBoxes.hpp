...
namespace game_engine {
    namespace utility {
        ...
        private:
            ...
            protected:
                ...
                */
                ...
                Point2D GetQuadrantOrigin(short quadrant) {
                    Point2D new_node_origin = origin_;
            ...
            public:
                QuadTreeBoxesLeafNode(Point2D origin, Real_t length) {
                    this->origin_ = origin;
                    this->length_ = length;
            ...
            public:
                QuadTreeBoxesInnerNode(Point2D origin, Real_t length) {
                ...
                QuadTreeBoxesNode * Insert(Data data, AABox<2> box, std::unordered_map<Data, AABox<2>>& boxes, size_t depth) {
                    ...
                    for (size_t i = 0; i < children_.size(); i++) {
                        Point2D child_origin = QuadTreeBoxesNode::GetQuadrantOrigin(static_cast<short>(i));
        ...
        public:
            ...
            */
            QuadTreeBoxes(Point2D origin, Real_t length) {
                origin_ = origin;
                length_ = length;
