    ...
    namespace graphics {
        namespace opengl {
            ...
            int OpenGLShaderGBuffer::Init(std::string vertex_shader_path, std::string fragment_shader_path) {
                ...
                if ((uni_ShadowMap_ = GetUniformLocation(shader_uni_shadow_map)) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
            ...
            int OpenGLShaderFinalPass::Init(std::string vertex_shader_path, std::string fragment_shader_path) {
                ...
                if ((uni_texture_gbuffer_ambient_ = GetUniformLocation(shader_gbuffer_ambient)) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
