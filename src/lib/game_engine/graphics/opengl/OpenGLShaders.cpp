...
namespace game_engine { namespace graphics { namespace opengl {
    ...
    int OpenGLShaderVerticesColor::Init(std::string vertex_shader_path, std::string fragment_shader_path) {
        ...
        if ((uni_fragment_alpha_ = GetUniformLocation(shader_vertices_color_uni_alpha)) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
    ...
    int OpenGLShaderFinalPass::Init(std::string vertex_shader_path, std::string fragment_shader_path) {
        ...
        if ((uni_shadow_map_3_ = GetUniformLocation(shader_uni_shadow_map + "[3]")) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
        ...
        if ((uni_matrix_lightspace_3_ = GetUniformLocation(shader_uni_lightspace + "[3]")) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
        ...
        if ((uni_shadow_cascade_3_ = GetUniformLocation("shadow_cascades[3]")) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
