...
namespace game_engine {
    namespace graphics {
        namespace opengl {
            ...
            void OpenGLShader::SetUniformVec2(GLuint id, glm::vec2 & vector) {
                glUniform2fv(id, 1, &vector[0]);
            }
            ...
            int OpenGLShaderGBuffer::Init(std::string vertex_shader_path, std::string fragment_shader_path) {
                ...
                if ((uni_displacement_texture_ = GetUniformLocation(shader_gbuffer_displacement_texture)) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
                if ((uni_displacement_mult_ = GetUniformLocation(shader_gbuffer_displacement_mult)) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
            ...
            int OpenGLShaderWater::Init(std::string vertex_shader_path, std::string fragment_shader_path) {
                ...
                if ((attr_vertex_position_ = GetAttributeLocation(shader_vertex_position)) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
                if ((attr_vertex_uv_ = GetAttributeLocation(shader_vertex_uv)) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
                if ((uni_u_texture_ = GetUniformLocation(shader_uni_u_texture)) == -1) return Error::ERROR_SHADER_RES_NOT_FOUND;
